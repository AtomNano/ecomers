<footer class="bg-primary-900 text-white">
    <div class="container-custom section-padding">
            ...
            <div class="lg:col-span-2">
                <div class="flex items-center space-x-2 mb-4">
                    <div class="w-10 h-10 bg-white rounded-lg flex items-center justify-center">
                        <span class="text-primary-600 font-bold text-lg">BI</span>
                    </div>
                    <div>
                        <h3 class="text-xl font-bold">Grosir Berkat Ibu</h3>
                        <p class="text-primary-200 text-sm">Platform Grosir Digital</p>
                    </div>
                </div>
                <p class="text-primary-200 mb-6 max-w-md">
                    Platform grosir digital terpercaya dengan sistem harga bertingkat yang fleksibel. 
                    Transaksi mudah, harga kompetitif, dan pengiriman cepat untuk kebutuhan bisnis Anda.
                </p>
                ...
                <div class="space-y-2">
                    <div class="flex items-center space-x-3">
                        ...
                        <span class="text-primary-200">Jl.timur, Ulak Karang Utara, Kec. Padang Utara, Kota Padang, Sumatera Barat 25000</span>
                    </div>
                    <div class="flex items-center space-x-3">
                        <svg class="h-5 w-5 text-primary-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                        </svg>
                        <span class="text-primary-200">+62 21 1234 5678</span>
                    </div>
                    <div class="flex items-center space-x-3">
                        <svg class="h-5 w-5 text-primary-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                        </svg>
                        <span class="text-primary-200">info@grosirberkatibu.com</span>
                    </div>
                </div>
            </div>
        ...
        <!-- Bottom Bar -->
        <div class="border-t border-primary-800 mt-8 pt-8">
            <div class="flex flex-col md:flex-row justify-between items-center">
                <div class="text-primary-200 text-sm mb-4 md:mb-0">
                    © {{ date('Y') }} Grosir Berkat Ibu. Semua hak dilindungi.
                </div>
