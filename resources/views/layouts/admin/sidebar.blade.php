    ...
    <nav class="mt-6">
        <div class="px-3 space-y-1">
            ...
            <a href="{{ route('admin.categories.index') }}" 
               class="group flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors {{ request()->routeIs('admin.categories.*') ? 'bg-primary-100 text-primary-700' : 'text-neutral-700 hover:bg-neutral-100 hover:text-neutral-900' }}">
                <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="px-3 mt-6">
            <div class="border-t border-neutral-200 pt-6">
                ...
                <a href="{{ route('owner.admins.index') }}" 
                   class="group flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors {{ request()->routeIs('owner.admins.*') ? 'bg-primary-100 text-primary-700' : 'text-neutral-700 hover:bg-neutral-100 hover:text-neutral-900' }}">
                    <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
