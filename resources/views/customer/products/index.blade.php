...
@section('content')
    <div x-data="{ mobileFilterOpen: false }" class="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div class="lg:col-span-1">
            ...
            <!-- Filter Card -->
            <div v-show="mobileFilterOpen || window.innerWidth >= 1024"
                class="lg:block bg-white rounded-xl shadow-md p-6 sticky top-24 max-h-[calc(100vh-150px)] overflow-y-auto">
                <h2 class="text-xl font-bold mb-6 flex items-center gap-2">
                    <i class="fas fa-sliders-h text-red-600"></i> Filter Produk
                </h2>
                ...
                <form method="GET" action="{{ route('customer.products.index') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="text" name="search" value="{{ request('search') }}" placeholder="Nama produk..."
                                class="w-full border-2 border-gray-200 rounded-lg px-4 py-2 focus:border-red-500 focus:outline-none transition">
                    ...
                    <div>
                        ...
                        <select name="sort"
                            class="w-full border-2 border-gray-200 rounded-lg px-3 py-2 focus:border-red-500 focus:outline-none transition">
                    ...
                    <button type="submit"
                        class="w-full bg-gradient-to-r from-red-600 to-orange-600 text-white py-3 rounded-lg hover:shadow-lg transition font-semibold">
                        <i class="fas fa-filter"></i> Terapkan Filter
                    </button>

                    @if(request()->has('search') || request()->has('category') || request()->has('max_price') || request()->has('sort') || request()->has('in_stock'))
                        <a href="{{ route('customer.products.index') }}"
                            class="w-full block bg-gray-200 text-gray-800 py-3 rounded-lg hover:bg-gray-300 transition font-semibold text-center">
        ...
        <div class="lg:col-span-3">
            ...
            <div class="mb-8">
                <h1 class="text-4xl font-bold text-gray-800 mb-2">
                    <i class="fas fa-box text-red-600"></i> Daftar Produk
                </h1>
            ...
            @if($products->count())
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                    @foreach($products as $product)
                        <div
                            class="group bg-white rounded-xl overflow-hidden shadow-md hover:shadow-2xl transition transform hover:scale-105">
                            <!-- Product Image -->
                            <div class="relative bg-gradient-to-br from-gray-100 to-gray-200 h-64 overflow-hidden">
                                ...
                                <div class="absolute top-4 right-4">
                                    <span class="bg-red-600 text-white px-3 py-1 rounded-full text-xs font-semibold shadow-sm">
                            ...
                            <div class="p-5">
                                ...
                                <!-- Pricing -->
                                <div class="mb-4 bg-gradient-to-r from-red-50 to-orange-50 p-3 rounded-lg border border-red-100">
                                ...
                                @if($product->stock > 0)
                                    <form action="{{ route('customer.cart.add', $product) }}" method="POST" class="w-full">
                                        ...
                                        <div class="flex gap-2">
                                            <button type="submit"
                                                class="flex-1 bg-gradient-to-r from-red-500 to-orange-500 hover:from-red-600 hover:to-orange-600 text-white font-bold py-3 rounded-lg transition transform hover:scale-105 flex items-center justify-center gap-2 shadow-sm">
                                                <i class="fas fa-cart-plus"></i> Keranjang
                                            </button>
                                            <a href="{{ route('customer.products.show', $product) }}"
                                                class="flex-1 bg-blue-50 hover:bg-blue-100 text-blue-600 font-bold py-3 rounded-lg transition flex items-center justify-center gap-2">
            ...
            @else
                ...
                <div class="bg-white rounded-xl shadow-md p-12 text-center">
                    ...
                    <a href="{{ route('customer.products.index') }}"
                        class="inline-block px-6 py-3 bg-red-600 hover:bg-red-700 text-white font-bold rounded-lg transition">
