...
<div class="bg-white">
    <div class="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
        <div class="text-center">
            ...
            <h1 class="mt-4 text-3xl font-extrabold text-gray-900">Pesanan Berhasil!</h1>
            <p class="mt-2 text-lg text-gray-600">Terima kasih atas pesanan Anda. Silakan lakukan pembayaran untuk melanjutkan proses.</p>
        </div>
        ...
        <div class="mt-12 max-w-3xl mx-auto">
            <div class="bg-gray-50 rounded-lg p-6">
                ...
                <dl class="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <dd class="mt-1 text-sm text-gray-900">Rp {{ number_format($order->total_price, 0, ',', '.') }}</dd>
                    </div>
                    <div>
            ...
            <div class="mt-8 bg-blue-50 rounded-lg p-6">
                <h2 class="text-lg font-medium text-gray-900 mb-4">Instruksi Pembayaran</h2>
                <div class="space-y-4">
                    <div>
                        <h3 class="text-sm font-medium text-gray-900">Transfer Bank</h3>
                        <p class="mt-1 text-sm text-gray-600">
                            Silakan transfer ke rekening berikut:<br>
                            Bank: BCA<br>
                            No. Rekening: 1234567890<br>
                            Atas Nama: Grosir Berkat Ibu
                        </p>
                    </div>
                    <div>
                        <h3 class="text-sm font-medium text-gray-900">QRIS</h3>
                        <p class="mt-1 text-sm text-gray-600">
                            Scan QR code berikut untuk pembayaran QRIS
                        </p>
                        <div class="mt-2">
                            <img src="https://placehold.co/200x200/f3f4f6/374151?text=QRIS" alt="QRIS" class="h-32 w-32">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-8">
                ...
                <form action="{{ route('checkout.uploadProof', $order) }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                    @csrf
                    <div>
                        <label for="proof_of_payment" class="block text-sm font-medium text-gray-700">Bukti Pembayaran</label>
                        <input type="file" 
                               id="proof_of_payment" 
            ...
            <div class="mt-8 text-center">
                <p class="text-sm text-gray-600">Butuh bantuan? Hubungi kami via WhatsApp</p>
