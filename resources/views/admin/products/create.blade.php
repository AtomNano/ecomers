...
<div class="max-w-4xl mx-auto">
    ...
    <div class="flex items-center gap-4 mb-6">
        ...
        <div>
            <h1 class="text-2xl lg:text-3xl font-bold text-gray-800">Tambah Produk Baru</h1>
            <p class="text-gray-500 text-sm">Isi informasi produk dengan lengkap</p>
        </div>
    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="4" 
                                      placeholder="Jelaskan detail produk, manfaat, dan informasi penting lainnya..."
                                      class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-emerald-500 focus:border-transparent" required>{{ old('description') }}</textarea>
                            @error('description')
                                <p class="text-red-600 text-sm mt-1"><i class="fas fa-exclamation-circle"></i> {{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="p-4 bg-blue-50 rounded-xl border-2 border-blue-200">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="price_unit" value="{{ old('price_unit') }}" step="1" min="100"
                                           placeholder="25000"
                        ...
                        <div class="p-4 bg-amber-50 rounded-xl border-2 border-amber-200">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="number" name="bulk_min_qty" value="{{ old('bulk_min_qty', 4) }}" min="2" max="100"
                                               placeholder="4"
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <span class="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500">Rp</span>
                                        <input type="number" name="price_bulk_4" value="{{ old('price_bulk_4') }}" step="1" min="100"
                                               placeholder="23000"
                        ...
                        <div class="p-4 bg-emerald-50 rounded-xl border-2 border-emerald-200">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="number" name="box_item_count" value="{{ old('box_item_count', 12) }}" min="2" max="999"
                                               placeholder="12"
                                               class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-emerald-500 focus:border-transparent">
                                        <span class="absolute right-4 top-1/2 -translate-y-1/2 text-gray-500 text-sm">pcs</span>
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <span class="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500">Rp</span>
                                        <input type="number" name="price_dozen" value="{{ old('price_dozen') }}" step="1" min="100"
                                               placeholder="20000"
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <div class="bg-white rounded-2xl shadow-lg p-6">
                    ...
                    <div class="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:border-emerald-500 transition cursor-pointer" onclick="document.getElementById('image-input').click()">
                        ...
                        <div id="image-placeholder">
                            ...
                            <p class="text-sm text-gray-500 mb-1">Klik untuk upload gambar</p>
                ...
                <div class="space-y-3">
                    ...
                    <a href="{{ route('admin.products.index') }}" class="block w-full py-3 bg-gray-100 text-gray-700 rounded-xl hover:bg-gray-200 transition text-center font-medium">
