                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('admin.categories.update', $category) }}" method="POST">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name', $category->name) }}" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm @error('name') border-red-500 @enderror">
                            @error('name')
